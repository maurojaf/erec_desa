			...
			<%If strTipoPriorizacion = 1 or strTipoPriorizacion = 0 then%>
				...
				<thead>
					...
					<%AbrirSCG()
						...
						strSql = strSql & " WHERE PR.COD_CLIENTE = '" & strCodCliente & "' AND PRC.ESTADO_PRIORIZACION = 0 AND ESTADO_DEUDA.ACTIVO = 1 AND (DATEDIFF(MINUTE,(ISNULL(FECHA_AGEND_ULT_GES,GETDATE()-200)+ convert(varchar(10),ISNULL(HORA_AGEND_ULT_GES,'00:00'),108)),GETDATE()) >= 0)"
						...
						%>
							...
							<tr >
								...
								<td class="Estilo4">&nbsp;</td>
								<td width = "80" class="Estilo4">FECHA</td>
						...
						<%
							...
							strTotalDoc = ""
								...
								AbrirSCG2()
											...
											strSql= strSql & " WHERE PRC.ID_PRIORIZACION = '" & intIdPriorizacion & "' AND PRC.ESTADO_PRIORIZACION = 0 AND ESTADO_DEUDA.ACTIVO = 1 AND (DATEDIFF(MINUTE,(ISNULL(FECHA_AGEND_ULT_GES,GETDATE()-200)+ convert(varchar(10),ISNULL(HORA_AGEND_ULT_GES,'00:00'),108)),GETDATE()) >= 0)"
								...
								<tr >
									...
									<td><%=strFechaPrio%></td>							
									<td ALIGN="left">
										<a href="detalle_gestiones.asp?rut=<%=strRutDeudor%>&cliente=<%=strCodCliente%>" onclick="javascript:SetCustomer('<%=strCodCliente%>');">
									...
									<td align = "center" class="Estilo4" onClick="priorizar_caso('<%=strRutDeudor%>','<%=strCodCliente%>');" value="Priorizar caso" title="<%=strObsPrio%>"><img src="../imagenes/priorizar_urgente.png" border="0"></td>

									<td><%=strUsuarioAsig%></td>
									<td><%=strUsuarioPrio%></td>
									<td align="center" class="Estilo4" title="<%=strTotalDoc%>">
										<img src="../imagenes/carpeta1.png" border="0">
										
									<td align="center" class="Estilo4" title="Confirmar Priorización">
											<A HREF="#" onClick="ConfirmarPrio(<%=rsPriorizacion("ID_PRIORIZACION")%>)";><img src="../imagenes/GestionarRoj.png" border="0"></A>
									</td>
						...
						CerrarSCG()%>
								...
								<thead>
								<tr >
									<td class="totales" colspan = "12">&nbsp;</td>
								</tr>
								</thead>
					 ...
					 <%Else%>
					 	<thead>
							...
							<tr >
								<td height="30" Align="CENTER" Colspan = "12" class="estilo_columna_individual">NO HAY PRIORIZACIONES PENDIENTES A GESTIONAR</td>
							</tr>
				...
				<thead>
					...
					<%AbrirSCG()
					 ...
					 <%Else%>
							...
							<tr >
								<td height="30" Align="CENTER" Colspan = "12" class="estilo_columna_individual">NO HAY PRIORIZACIONES AGENDADAS</td>
							</tr>
				...
				<thead>
					...
					<%AbrirSCG()
						...
						<%
							...
							strTotalDoc = ""
								...
								<tr >
									...
									<td align = "center" class="Estilo4" onClick="priorizar_caso('<%=strRutDeudor%>','<%=strCodCliente%>');" value="Priorizar caso" title="<%=strObsConf%>"><img src="../imagenes/priorizar_urgente.png" border="0"></td>

									<td align="center" class="Estilo4" title="<%=strTotalDoc%>">
										<img src="../imagenes/carpeta1.png" border="0">
									<td align="center" class="Estilo4" title="Confirmar Priorización">
											<A HREF="#" onClick="ConfirmarPrio(<%=rsPriorizacion("ID_PRIORIZACION")%>)";><img src="../imagenes/bt_confirmar.jpg" border="0"></A>
									</td>
								</tr>
						...
						CerrarSCG()%>
							...
							<thead>
								<tr >
									<td class="totales" colspan = "14">&nbsp;</td>
								</tr>
							</thead>
						 ...
						 <%Else%>
						 	<thead>
								...
								<tr >
									<td height="30" Align="CENTER" Colspan = "14" class="estilo_columna_individual">NO HAY PRIORIZACIONES CONFIRMADAS</td>
								</tr>
...
function priorizar_caso(strRutDeudor,strCodCliente){
	datos.action='priorizar_caso.asp?strCodCliente=<%=strCodCliente%>&strRut=' + strRutDeudor;
	datos.submit();
}
...
function ConfirmarPrio(id_gestion)
{
	datos.action = "Confirmar_Priorizacion.asp?strOrigen=1&strCodCliente=<%=strCodCliente%>&strRutDeudor=<%=strRutDeudor%>&id_gestion=" + id_gestion ;
	datos.submit();
