...
<%
	...
	sql_sel_casos = sql_sel_casos & " VV.COD_DEUDOR_CLIENTE, "
	sql_sel_casos = sql_sel_casos & " VV.COD_DOC_CLIENTE, "
...
<body>
	...
	<%
		...
		intCodDeudorCliente		=rs_casos_gestion("COD_DEUDOR_CLIENTE")
		intCodDocCliente		=rs_casos_gestion("COD_DOC_CLIENTE")
		...
		<tr class="td_hover" bgcolor="<%=bgcolor%>">
			...
			<td valign="top"><%=trim(intCodDeudorCliente)%></td>
			<td valign="top"><%=trim(intCodDocCliente)%></td>
