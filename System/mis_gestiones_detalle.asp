...
strSql = strSql & "	FECHA_INGRESO,HORA_INGRESO,FECHA_COMPROMISO,OBSERVACIONES ,COD_GESTION, ID_USUARIO , TELEFONO "
strSql = strSql & " order by RUT_DEUDOR,COD_CATEGORIA,COD_SUB_CATEGORIA,ISnull(COD_GESTION,0), "
strSql = strSql & " FECHA_INGRESO,HORA_INGRESO,FECHA_COMPROMISO,OBSERVACIONES,ID_USUARIO , TELEFONO "
